...
public class BloodForestFruitDecorator extends CocoaDecorator {
	public static final BloodForestFruitDecorator INSTANCE = new BloodForestFruitDecorator();
	public static com.mojang.serialization.Codec<BloodForestFruitDecorator> codec;
